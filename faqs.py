...
<body>
                        ...
                        <div class="modal-body">
                                <form  name="shopsignup" method="post" enctype="multipart/form-data" >
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="simage" id="simage" class="form-control" required><br>
    ...
    <div class="container-fluid" id="container1">
        <div class="row">
            ...
            <div class="col-md-5">
                <img src="./assets/cart3.png" alt="image" height="300px" width="400px">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid" id="container1">
        <div class="row">
            <div class="jumbotron" id="container2">
                ...
                <ul>
                    <li><h2>Are you User?</h2></li>
                    <li><h3>Sign up Now: <a href="" data-toggle="modal" data-target="#usermodal1">Click Here</a></h3></li>
                </ul>
                <ul>
                    <li><h2>Are you a Shopkeeper?</h2></li>
                    <li><h3>Register your Shop: <a href="" data-toggle="modal" data-target="#shopmodal1">Click Here</a></h3></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    if len(form) != 0:
        ...
        if is_semail_exists(semail):
            ...
            if ownerphoto.filename and shoplicense.filename and owneradd.filename and shopimg.filename:
                ...
                shopname, ownername, gender, ownerage, shopyear, semail, sphno, swappno, saddress, scity, sstate,
                fnowner, fnshoplicense, fnowneradd, fnshopimg)
                cur.execute(q)
                con.commit()
                print("""
                        <script>
