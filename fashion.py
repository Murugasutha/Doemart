...
cur.execute(q1)
recc = cur.fetchall()
q = """Select* from addproduct where category = "Clothing" """
cur.execute(q)
rec = cur.fetchall()

q2 = """Select* from shopregister"""
cur.execute(q2)
rec1 = cur.fetchall()
...
for i in rec:
    if i[8] ==0:
        ...
        print("""
                <div class="col-md-3 text-center dress">
                    <div class="dress-card">
                        ...
                        <a href="buynow.py?id=%s&userid=%s&shopid=%s"><button type="button" class="btn btn-dark" style="font-size: 20px;">Buy Now</button></a>
                    </div>
                </div>
        """%(fn,i[2],i[2],i[3],i[6],i[0],ID,i[9]))
    else:
        fn = "product/" + i[7]
        offer = float(i[8])
        price = float(i[6])
        ...
        print("""
                ...
                """ % (fn, i[2], i[2], i[3], i[6],offerprice,  i[0], ID, i[9]))
print("""
