                            ...
                            <tbody>
                                ...
                                <form method="post">
                                    ...
                                    <td>
                                            ...
                                            <button type="button"  class="btn btn-primary text-center" data-toggle="modal" data-target="#addproduct-%s"><span class="glyphicon glyphicon-plus plus"></span></button>
    """ % (i[1], i[2], i[6], i[8], i[0], i[0]))
    print("""
        <!-- Add product -->
                <div class="modal fade" id="addproduct-%s"  role="dialog">
                            ...
                            <div class="modal-body">
                                <form action="" method="get" enctype="multipart/form-data">
                                    <table class="table add">
                                        <tr>
                                            <th>Product Id</th>
                                            <td><input type="number" value="%s" name="proid" class="form-control" readonly></td>
                                        </tr>
                                        <tr>
                                            <th>Product Name</th>
                                            <td><input type="text" value="%s" name="proname" class="form-control" readonly></td>
                                        </tr>
                                        <tr>
                                            <th>Price</th>
                                            <td><input type="number" value="%s" name="price" class="form-control" readonly></td>
                                        </tr>
                                        <tr>
                                            <th>Offer</th>
                                            <td><input type="number" value="%s" name="offer" class="form-control"></td>
                                        </tr>
                                    </table>
                                    <center><input type="submit" name="add" value="Add offer" class="btn btn-md btn-primary"></center>
                                </form>
                            </div>
                        </div>
                    </div>
...
if add != None:
    if len(form) != 0:
        q = """UPDATE addproduct SET offer='%s' where productid ="%s" """ % (offer, proid)
        cur.execute(q)
        con.commit()
        print("""
                    <script>
