...
<style>
    *{
    ...
    /* .table--wrapper table tr th:hover{
        background-color: #003f5c;
        color: #fff;
    } */
    .tabular--wrapper{
...
print("""
            <ul class="menu">
                ...
                <li>
                    <a href="shopkeeperdash.py?shopid=%s">
...
print("""
        <div class="main--container">
            <div class="main--title">
                ...
                <div class="col-md-2">
                    <button type="button" class="btn btn-primary text-center" data-toggle="modal" data-target="#addproduct"><span class="glyphicon glyphicon-plus plus"></span> Add Product</button>
                </div>
            </div>
            <!-- Add product -->
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <table class="table add">
                                    <tr>
                                        <th>Product Id</th>
                                        <td><input type="number" name="proid" class="form-control"></td>
                                    </tr>
                                    <tr>
                                        <th>Product Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="des"  cols="30" rows="10" class="form-control" ></textarea></td>
                                    </tr>
                                    <tr>
                                        <th>Category</th>
                                    ...
                                    <tr>
                                        <th>Product Image</th>
                                        <td><input type="file" name="pimg" class="form-control btn btn-default"></td>
                                    </tr>
                                </table>
                                <center><input type="submit" name="add" value="Add_Product" class="btn btn-md btn-primary"></center>
                            </form>
                        </div>
    ...
    print("""                   
                            <tbody>
                                <tr>
                                    ...
                                    <td>%s<td>
                                    <td>%s<td>
                                    <td><a href=""  data-toggle="modal" data-target="#ptdimg-%s"><span class="glyphicon glyphicon-picture"><span></a>
                                        <!-- Modal -->
                                        <div class="modal fade" id="ptdimg-%s" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                ...
                                """ %(i[1],i[2],i[3],i[4],i[5],i[6],i[0],i[0],fn))
...
if add != None:
    if len(form) != 0:
        ...
        if proimg.filename:
            ...
            q = """Insert into addproduct(productid,productname,description,category,quantity,price,productimg,shopid) values('%s','%s','%s','%s','%s','%s','%s','%s')""" %(proid,proname,prodes,category,quantity,price,fn,ID)
            cur.execute(q)
            con.commit()
            print("""
            <script>
