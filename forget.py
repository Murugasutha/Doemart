                    ...
                    <div class="login-container">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="email" name="userid" placeholder="Enter your usermail" id="hover1"
...
if submit != None:
    if is_uemail_exists(email):
        ...
        q = """Select password from useregister where email="%s" """ % (email)
        cur.execute(q)
        passw = cur.fetchone()
        formadd = "murugasutha18@gmail.com"
        password = "btcr euiw gplh ddrj"
        toadd = email
        subject = "Welcome To Do Emart"
