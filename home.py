            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a href="home.html" class="navbar-brand">DoEmart</a>
                    </div>
                    <div class="collapse navbar-collapse" id="mynav">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="offer.py"><span class="glyphicon glyphicon-gift"></span>Offers</a></li>
                        ...
                        <div class="modal-body">
                                <form  name="shopsignup" method="post" enctype="multipart/form-data" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sname" name="sname" placeholder="Eg. Kanna Silks" class="form-control" required>
                                        <label for="" id="label">Owner Name <span class="glyphicon glyphicon-asterisk"></span></label> 
                                        <input type="text" id="oname" name="oname"  placeholder="Eg. Sutha" class="form-control" required>
                                        ...
                                        <input type="email" name="email" id="email" class="form-control" placeholder="Eg. mailid@gmail.com" required>
                                        
                                        <label for="" id="label" name="label" >Mobile Number <span class="glyphicon glyphicon-asterisk"></span> </label>
                                        <input type="number" name="phno" id="phno" class="form-control" maxlength="10" required>
        
                                        <label for="" id="label">WhatsApp Number <span class="glyphicon glyphicon-asterisk"></span> </label>
                                        <input type="number" name="wappno" id="wappno" class="form-control" maxlength="10" required>
        
                                        <label for="" id="label">Shop Address  <span class="glyphicon glyphicon-asterisk"></span> </label> 
                                        <input type="text" id="door" name="door" class="form-control"  placeholder="Door no." required>
                                        ...
                                        <input type="number" id="pin" name="pin" placeholder="Pincode" class="form-control" maxlength="6" required>
                                    
                                        <label for="" id="label">City  <span class="glyphicon glyphicon-asterisk"></span></label> 
                                        <input type="text" id="city" name="city" class="form-control" placeholder="Eg. Tuticorin" required>
                                    
                                        <label for="" id="label"> State <span class="glyphicon glyphicon-asterisk"></span></label> 
                                        <input type="text" id="state" name="state" class="form-control" placeholder="Eg. India" required>
                                        ...
                                        <input type="file" name="slicence" id="slicence" class="form-control" required>
                                        
                                        <label for="" id="label">Owner Address Proof  <span class="glyphicon glyphicon-asterisk"></span></label> 
                                        <input type="file" name="addproof" id="addproof" class="form-control" required>
                                        ...
                                        <label for="" id="label">About your organization <span class="glyphicon glyphicon-asterisk"></span></label> 
                                        <textarea name="about"  cols="30" rows="5" class="form-control" ></textarea><br>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <form action="home.py" method="post" enctype="multipart/form-data" name="usersignup" onsubmit="usersign()">
                                    ...
                                    <input type="text" id="fname" name="fname" placeholder="Eg. Sutha" class="form-control"  required>
                                    
                                    <label for="" id="label">Last Name <span class="glyphicon glyphicon-asterisk"></span></label> 
                                    <input type="text" id="lname" name="lname" placeholder="Eg. Kailasam" class="form-control" required>
                                    ...
                                    <label for="" id="label" name="label" >Mobile Number <span class="glyphicon glyphicon-asterisk"></span> </label>
                                    <input type="number" name="uphno" id="uphno" maxlength="10" class="form-control" required>
        
                                    <label for="" id="label">WhatsApp Number <span class="glyphicon glyphicon-asterisk"></span> </label>
                                    <input type="number" name="uwappno" id="uwappno" maxlength="10"class="form-control" required>
                                    
                                    <label for="" id="label">Address  <span class="glyphicon glyphicon-asterisk"></span> </label> 
                                    <input type="text" id="door" name="udoor"  placeholder="Door no." class="form-control" required>
                                    <input type="text" id="street" name="ustreet" placeholder="Street Name" class="form-control" required>
                                    <input type="text" id="district" name="udistrict" placeholder="District" class="form-control" required>
                                    <input type="text" id="pin" name="upin" placeholder="Pincode" class="form-control" required>
                                   
                                    <label for="" id="label">City  <span class="glyphicon glyphicon-asterisk"></span></label> 
                                    <input type="text" id="city" name="ucity" placeholder="Eg. Tuticorin" class="form-control" required>
                                   
                                    <label for="" id="label"> State  <span class="glyphicon glyphicon-asterisk"></span></label> 
                                    <input type="text" id="state" name="ustate" placeholder="Eg. Tamil Nadu --090-" class="form-control" required>
                                    
                                    <label for="" id="label">Email Id  <span class="glyphicon glyphicon-asterisk"></span></label> 
                                    <input type="email" name="uemail" id="email" placeholder="Eg. mailid@gmail.com" class="form-control" required> 
                                                                       
                                    <label for="" id="label">Aadhaar Card<span class="glyphicon glyphicon-asterisk"></span></label> 
                                    <input type="file" name="aadhar" id="aadhar" class="form-control" required><br><br>
    ...
    <div class="container-fluid" id="container">
        <div class="row" id="content">
            <div class="col-md-8" id="col1">
                <div class="text1">
                    <h2>Welcome to  DoEmart <h4>Your ultimate Buisness Directory </h4></h2>
                <h2>Connecting Buisness and Consumers Directly <h4>Discover connect and shop with ease</h4></h2>
                <a href="#login" id="loginhighlight" style="text-decoration: none;"><button class="btn btn-danger btn-lg">Get Started <span class="glyphicon glyphicon-chevron-right"></span></button></a>
                </div>
            </div>
            <div class="col-md-4" id="col2">
                <img src="./assets/cart2.png" alt="Image" height="400px" width="400px" id="img1">
            </div>
        </div>
    </div>
    <script>
        $(document).ready(function () {
            $("#loginhighlight").click(function () {
                $("#login").toggleClass("highlight");
            });
        });
    </script>
    <!-- content2 -->
    <div class="container-fluid" id="container">
        <div class="row" id="content">
            <div class="col-md-4" id="col3">
                <img src="./assets/cart1.png" alt="image" height="350px" width="350px" id="img2">
            </div>
            <div class="col-md-8" id="col4">
                <div class="text2">
                    <h2>Why DoEmart?</h2>
                    <h4>DoEmart is not just a Buisness Directory</h4> 
                    <h4>it is a dynamic platform that bring together small-scale shopkeeper, rular buisness and consumers creating a vibrant market place.</h4>
                    <h4> Here's why you should be part of it;</h4>
                    <ul>
                        <li><span class="glyphicon glyphicon-ok"></span> Direct Communication</li>
                        <li><span class="glyphicon glyphicon-ok"></span> Diverse Offers</li>
                        <li><span class="glyphicon glyphicon-ok"></span> User-friendly Interface</li>
                        <li><span class="glyphicon glyphicon-ok"></span> Feedback System</li>
                    </ul>   
                </div>         
            </div>
        </div>
...
def is_semail_exists(email):
    count = "SELECT COUNT(*) FROM shopregister WHERE email='%s'" % email
    cur.execute(count)
    result = cur.fetchone()
    return result[0] > 0

def is_vaidate_phno(phoneno):
    validateno = phoneno
    return len(validateno) == 10

def is_vaidate_pin(pincode):
    validateno = pincode
    return len(validateno) == 6
...
if ssubmit != None:
    if len(form) != 0:
        ...
        if not is_vaidate_phno(sphno):
            print("""
                        <script>
                            alert("Invalid phone number.enter 10 digit number");
                        </script>
            """)
        if not is_vaidate_phno(swappno):
            print("""
                        <script>
                            alert("Invalid phone number.enter 10 digit number");
                        </script>
            """)
        if not is_vaidate_pin(pinn):
            print("""
                        <script>
                            alert("Invalid pincode.enter 6 digit number");
                        </script>
            """)
        if is_semail_exists(semail):
            print("""
                        <script>
            ...
            if ownerphoto.filename and shoplicense.filename and owneradd.filename and shopimg.filename:
                ...
                q = """INSERT INTO `shopregister`( shopname, ownername, gender, age, shopyear, email, phno, wappno, address, city, state, ownerimg, license, addproof,shopimg,about) values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')""" %(shopname,ownername,gender,ownerage,shopyear,semail,sphno,swappno,saddress,scity,sstate,fnowner,fnshoplicense,fnowneradd,fnshopimg,about)
                cur.execute(q)
                con.commit()
                print("""
                        <script>
...
if usubmit != None:
    if len(form) != 0:
        ...
        upinn = form.getvalue("upin")
        ucity = form.getvalue("ucity")
        ustate = form.getvalue("ustate")
        uemail = form.getvalue("uemail")
        if not is_vaidate_phno(uphno):
            print("""
                        <script>
                            alert("Invalid phone number.enter 10 digit number");
                        </script>
            """)
        if not is_vaidate_phno(uwappno):
            print("""
                        <script>
                            alert("Invalid phone number.enter 10 digit number");
                        </script>
            """)
        if not is_vaidate_pin(upinn):
            print("""
                        <script>
                            alert("Invalid pincode.enter 6 digit number");
                        </script>
            """)
        if is_uemail_exists(uemail):
            print("""
                        <script>
                            alert("Email already exists. Please use a different email.");
                        </script>
            ...
            if aadhar.filename:
                ...
                q1 = """INSERT INTO useregister(firstname, lastname, gender, phno, wapp, address, city, state, email,  aadhar) values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')""" % (fname, lname, ugender, uphno, uwappno, uaddress, ucity, ustate,uemail,fnaadhar)
                cur.execute(q1)
                con.commit()
                print("""
                        <script>
